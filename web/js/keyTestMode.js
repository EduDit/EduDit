// Test Key Mode: press the physical key/paddle and see EduDit recognize
...
export class KeyTestMode {
  ...
  async _handleError(err) {
    ...
    if (err && (err.name === "NotAllowedError" || err.name === "SecurityError")) {
      ...
      await alertDialog("EduDit couldn't start your physical key input. Check Key Settings and try again.");
    }
    this.goBack();
  }
