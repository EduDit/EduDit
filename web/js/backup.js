...
const EXPORT_MARKER = "edudit_profile_export";
// Backups written before the app was renamed from DitDash use this marker;
// they must keep importing.
const LEGACY_EXPORT_MARKER = "ditdash_profile_export";
...
export function parseImportedProfile(jsonText) {
  ...
  const marker =
    parsed && typeof parsed === "object"
      ? parsed[EXPORT_MARKER] ?? parsed[LEGACY_EXPORT_MARKER]
      : undefined;
  if (marker !== EXPORT_VERSION) {
    throw new Error("That doesn't look like an EduDit profile backup file.");
  }
