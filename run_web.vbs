' Launch EduDit (web version) locally with no visible console window.
...
appData = shell.ExpandEnvironmentStrings("%APPDATA%") & "\EduDit"
...
If Not fso.FileExists(flagPath) Then
    ...
    CreateShortcut shell.SpecialFolders("Desktop") & "\EduDit.lnk"
    CreateShortcut shell.SpecialFolders("Programs") & "\EduDit.lnk"
End If
...
Sub CreateShortcut(path)
    ...
    link.Description = "Launch EduDit (web)"
